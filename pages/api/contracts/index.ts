...
const casinoABI = [
  {
    inputs: [
      { internalType: "uint256", name: "_purchaseRatio", type: "uint256" },
      { internalType: "uint256", name: "_betSize", type: "uint256" },
      { internalType: "uint256", name: "_payoutRatio", type: "uint256" },
    ],
  ...
  {
    inputs: [{ internalType: "bool", name: "_heads", type: "bool" }],
    name: "flipCoin",
  ...
  },
  {
    ...
    name: "nft",
    outputs: [
      { internalType: "contract CasinoPassport", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    name: "token",
    outputs: [
      { internalType: "contract CasinoToken", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
...
export default async function handler(
  ...
  if (req.method === "GET") {
    ...
    let casinoAddress = process.env.CASINO_CONTRACT_ADDRESS;
    ...
    try {
      ...
      const contracts = { casinoContract, tokenContract };
